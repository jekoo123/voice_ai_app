const words = [
  ...
  [
    ...
    "지금 가진 것이 나중에 가질 수도 있는 것보다 가치있다",
  ],
  ["A penny for your thoughts", "당신이 생각하는 것을 제게 말해 주세요"],
  [
    "A penny saved is a penny earned",
    "오늘 절약하는 돈은 나중에 사용할 수 있다",
  ],
  ["A perfect storm", "생각할 수 있는 최악의 상황"],
  [
    "A picture is worth 1000 words",
    "백번 말하는 것보다 한번 보여주는 것이 낫다",
  ],
  [
    "Actions speak louder than words",
    "사람들이 말하는 것이 아니라, 사람들이 하는 것을 믿다",
  ],
  ["Add insult to injury", "좋지 않은 상황을 더 악화시키다"],
  [
    "Barking up the wrong tree",
    "엉뚱한 사람을 비난하다, 잘못된 곳에서 해결책을 구하다",
  ],
  [
    "Birds of a feather flock together",
    "비슷한 사람들끼리 친해진다(보통 부정적으로 사용됨)",
  ],
  ...
  [
    ...
    '사람들을 공정하게 대하다. "황금 규칙"으로도 알려져 있음',
  ],
  [
    "Don't count your chickens before they hatch",
    "무엇인가 좋은 일이 정말로 일어나기 전에 일어났다고 의지하지 마라.",
  ],
  [
    "Don't cry over spilt milk",
    "어떻게 할 수 없는 것에 대해서는 불평할 이유가 없다",
  ],
  ["Don't give up your day job", "당신이 이것을 잘 하지 못한다"],
  [
    "Don't put all your eggs in one basket",
    "당신이 하고 있는 일은 너무 위험 부담이 크다",
  ],
  ...
  [
    ...
    "그는 지금 우리가 이야기하고 있는 것보다 더 중요한 일이 있다",
  ],
  ...
  [
    ...
    "멀리서는 좋게 보이지만, 좀 더 자세히 보면 문제가 있다",
  ],
  ...
  [
    ...
    "무엇인가 나쁜 일이 일어날 것이지만, 지금 당장은 조용하다",
  ],
  ...
  [
    ...
    "당신이 그 일을 할 수 없다면, 그것에 대해서 다른 사람들 탓하지 마라",
  ],
  ["It is always darkest before the dawn", "일들이 잘 될 것이다"],
  [
    "It takes two to tango",
    "한 사람 혼자서 책임이 없다. 두 사람 모두 책임이 있다",
  ],
  ...
  [
    ...
    "도덕적으로 문제가 있는 사람들은 다른 사람들을 비판해서는 안된다",
  ],
